namespace Conjuntos2
{
    class FonteDados
    {
        public static List<Aluno> GetTurmaA()
        {
            ...
            {
                new Aluno() { Nome = "Maria", Idade = 36, Nascimento = new DateTime(2001, 5, 11) },
                new Aluno() { Nome = "Manuel", Idade = 33, Nascimento = new DateTime(2000, 2, 10) },
        ...
        public static List<Aluno> GetTurmaB()
        {
            List<Aluno> alunos = new List<Aluno>()
            {
                ...
                new Aluno() { Nome = "Denize", Idade = 33, Nascimento = new DateTime(2004, 11, 5) },
            };
            return alunos;
        }
    }
